...
> There is also an ansible task / shell script to setup nix package manager, but this is how it is done step by step.
...
or, with my dotfiles here, run the alias `reflake`
